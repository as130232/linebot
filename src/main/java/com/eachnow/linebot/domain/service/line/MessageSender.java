...
//    }
    ...
    public void pushTextToCharles(String sendMessage) {
...
//        //時間段中文字串
//        endTimePeriodContents.add(Text.builder().text("翌日").size(FlexFontSize.SM).gravity(FlexGravity.CENTER).flex(5).weight(Text.TextWeight.BOLD).build());
